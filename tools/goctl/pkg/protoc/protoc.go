...
import (
	...
	"github.com/xiaoshouchen/go-zero/tools/goctl/pkg/downloader"
	"github.com/xiaoshouchen/go-zero/tools/goctl/pkg/goctl"
	"github.com/xiaoshouchen/go-zero/tools/goctl/rpc/execx"
	"github.com/xiaoshouchen/go-zero/tools/goctl/util/env"
	"github.com/xiaoshouchen/go-zero/tools/goctl/util/zipx"
	"github.com/xiaoshouchen/go-zero/tools/goctl/vars"
)

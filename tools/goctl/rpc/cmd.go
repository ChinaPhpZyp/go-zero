...
import (
	...
	"github.com/xiaoshouchen/go-zero/tools/goctl/rpc/cli"
)
...
func init() {
	...
	newCmd.Flags().StringVar(&cli.VarStringStyle, "style", "gozero", "The file naming format, see [https://github.com/xiaoshouchen/go-zero/tree/master/tools/goctl/config/readme.md]")
	...
	newCmd.Flags().StringVar(&cli.VarStringRemote, "remote", "", "The remote git repo of the template, "+
		"--home and --remote cannot be set at the same time, if they are, --remote has higher priority\n\tThe git repo "+
		"directory must be consistent with the https://github.com/xiaoshouchen/go-zero-template directory structure")
	...
	protocCmd.Flags().StringVar(&cli.VarStringStyle, "style", "gozero", "The file naming format, see [https://github.com/xiaoshouchen/go-zero/tree/master/tools/goctl/config/readme.md]")

...
* usermodel.go
  ...
  import (
      ...
      cachec "github.com/xiaoshouchen/go-zero/core/stores/cache"
      "github.com/xiaoshouchen/go-zero/core/stores/mongoc"
  )
...
OPTIONS:
   ...
   --style value           the file naming format, see [https://github.com/xiaoshouchen/go-zero/tree/master/tools/goctl/config/readme.md]
